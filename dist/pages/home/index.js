...
var Home = (_dec = (0, _index3.inject)('homeStore'), _dec(_class = (0, _index3.observer)(_class = (_temp2 = _class2 = function (_BaseComponent) {
  ...
  function Home() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Home.__proto__ || Object.getPrototypeOf(Home)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["loopArray0", "listData", "homeStore"], _this.config = {
      // 设置导航语
      navigationBarTitleText: 'Hello World!'
    }, _this.customComponents = ["Banner"], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  return Home;
}(_index.Component), _class2.$$events = ["onScrollToLower", "onScrollToUpper"], _class2.$$componentPath = "pages/home/index", _temp2)) || _class) || _class);
