...
var TabBar = (_temp2 = _class = function (_BaseComponent) {
  ...
  function TabBar() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = TabBar.__proto__ || Object.getPrototypeOf(TabBar)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["$compid__28"], _this.config = {
      // 设置导航语
  ...
  return TabBar;
}(_index.Component), _class.$$events = [], _class.$$componentPath = "common/TabBar/index", _temp2);
